...
public class AndroidUpdateSDKOld {
    private final String TAG = AndroidUpdateSDKOld.class.getSimpleName();
    Context context;
    private static AndroidUpdateSDKOld instance = null;

    public synchronized static AndroidUpdateSDKOld getInstance() {
        if (instance == null) {
            instance = new AndroidUpdateSDKOld();
        }
        return instance;
    }
