package com.zhaisoft.lib.updater.widget;
...
public class ZhaiAutoSplitTextView extends AppCompatTextView {
    ...
    public ZhaiAutoSplitTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ZhaiAutoSplitTextView(Context context, AttributeSet attrs, int defStyle) {
